...
import {Card,Form,Input,Button,Modal,DatePicker,Select,Radio, message} from 'antd';
       ...
       dataIndex: 'id'},
       {
        ...
        return (<div>
            ...
            <Card style={{marginTop:10}} className="operate-wrap">
                ...
                <Button type="danger" icon="delete" onClick={()=>this.handleOperator('delete')}>删除员工信息</Button>
            </Card>
            <ETable
            columns={columns}
